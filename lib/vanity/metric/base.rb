module Vanity
  ...
  class Metric
    ...
    def track_args(args)
      ...
      [timestamp || Time.now, identity, values || [1], extra_id || nil]
    end
    ...
    def call_hooks(timestamp, identity, values, extra_id)
      @hooks.each do |hook|
        hook.call @id, timestamp, values.first || 1, extra_id || nil
      end
    end
